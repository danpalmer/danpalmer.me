...
![A scan of a Hillsborough document](assets/post_images/hillsborough-original-document.png)
...
![CPU usage when OCR'ing the Hillsborough documents](assets/post_images/hillsborough-laptop-cpu.png)
...
![CPU usage on the server OCR'ing all of the documents](assets/post_images/hillsborough-server-cpu.png)
