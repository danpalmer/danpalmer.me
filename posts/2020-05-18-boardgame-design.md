...
Last year I bought a copy of Scythe from publisher Stonemaier Games, based in
large part on the art. I was very happy with the art and enjoy playing the game,
but what I found even more satisfying was the design of the iconography, the
rulebook, and the use of physical tokens to re-inforce processes used throughout
the game. This week I bought Wingspan from the same publisher, again based in
large part on the artwork, and once again I'm finding the other aspects even
more satisfying.
...
![Page from Wingspan rules](images/boardgames/wingspan_page.jpg)
...
![Page from Ticket to Ride rules](images/boardgames/ticket_to_ride_page.jpg)

One of the main things I like about the Wingspan rulebook is the progressive
information disclosure. Take this example...

![Step 1 description for laying an egg](images/boardgames/wingspan_subpage_1.png)
...
![Step 1 description diagram](images/boardgames/wingspan_subpage_2.png)
...
![Managing egg tokens](images/boardgames/wingspan_subpage_3.png)
...
make up a rule to fill in a gap, that rule probably won't be play-tested. Much of
the enjoyment of boardgames (and dislike of Monopoly) comes down to _balance_
(or lack thereof), and balance comes with play-testing.
...
![Designer's note from Scythe rulebook](images/boardgames/scythe_subpage_1.png)
...
![Bird specific reference in the Wingspan appendix](images/boardgames/wingspan_appendix.png)
...
bird cards with many different powers. In the same way that clear use of titles, emphasis in text, and diagrams creates progressive information disclosure that makes the rulebook so easy to process, moving the nitty gritty details into an appendix does the same. It's clear that this is reference material not designed to be learned.
...
![Scythe resource icons](images/boardgames/scythe_resources_padded.png)

Scythe has 5 core resources that players use in their economies. These are represented by the icons above.

![Scythe currency icons](images/boardgames/scythe_currencies.png)
...
Like most boardgames, Scythe uses these icons on the board to indicate
relevance...

![Power track](images/boardgames/scythe_power_track.png)
![Triumph track](images/boardgames/scythe_triumph_track.png)
![Popularity track](images/boardgames/scythe_popularity_track.png)
...
![Wingspan board iconography](images/boardgames/wingspan_board_iconography.png)
...
![Wingspan icons used as bullet points](images/boardgames/wingspan_inline_icons_1.png)
![Wingspan icon in-line in paragraph](images/boardgames/wingspan_inline_icons_2.png)

But Wingspan goes a step further and uses its icons in-line in the rulebook,
...
![Scythe territories and the resources they create](images/boardgames/scythe_territory_resources.png)
...
![Scythe cost and benefit icons](images/boardgames/scythe_cost_benefit.png)
...
![Scythe turn action cost benefit](images/boardgames/scythe_turn_action.png)
...
![Scythe benefits covered up by tokens](images/boardgames/scythe_action_1.png)
...
![Scythe costs to cover with tokens](images/boardgames/scythe_action_2.png)
...
- As players build their "engine"[2] along the rows, their action tokens have more places to move increasing the velocity of the game.
...
but in boardgames the aim is to have fun. [Much has also been written](pointing)
about how deliberate physical action helps reduce mistakes. But why do we want a
checklist, why do we need to reduce mistakes in boardgames?

For me boardgames become fun when the _practicalities_ disappear and the focus
...
Wingspan and Scythe are by no means the best boardgames on the market. Whether
...
While these design details are quite boardgame specific, I think there are more
